...
# Developer handle update
DEV_CREDIT = "@AAVYAxBOTS"
bot = telebot.TeleBot(API_TOKEN)

# --- DOWNLOAD LOGIC ---
def download_media(url, chat_id, message_id):
    # Pinterest aur baaki platforms ke liye heavy bypass
    ydl_opts = {
        'format': 'best',
    ...
    try:
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            # Ekdum saaf caption jaisa tune manga
            clean_caption = (
        ...
        bot.edit_message_text("❌ <b>ERROR:</b> Link invalid ya Pinterest video/image download nahi ho saki.", chat_id, message_id, parse_mode='HTML')
...
def start(message):
    welcome_text = (
        ...
        f"<blockquote>Kishi bhi platform (Pinterest, Insta, FB, YT) ka link bhejein, download turant shuru ho jayega!</blockquote>\n\n"
